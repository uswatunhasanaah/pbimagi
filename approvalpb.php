          ...
          <div class="card">
            <div class="card-body">
              ...
              <h2 class="text-center"><b>PERMOHONAN BIAYA</b></h2><br><br>
                <div class="card mb-0">
                  <div class="card-body">
                  <label for="">Keterangan Status : 
                              <span class="badge bg-success">Disetujui</span>
                              <span class="badge bg-danger">Belum</span>
                              <span class="badge bg-warning">Revisi</span>
                              <span class="badge bg-secondary">Update Revisi</span></label><br><br>
                      ...
                      <table class="table table-bordered" id="datatablee">
                        ...
                        <tbody>
                          ...
                          if($level == "Manager Keuangan"){
                            $data = mysqli_query($koneksi, "SELECT permohonanbiaya.*, user.nama FROM permohonanbiaya JOIN user ON permohonanbiaya.id_user=user.id and direktur='' ORDER BY id DESC");
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <a href="index.php?page=detailspbap&id=<?=$hdata[0]?>"><span class="badge bg-info">Details</span></a>
                              <?php if($hdata[14]!=0){ ?>
                                <a href="printpb.php?id=<?=$hdata[0]?>" target="_BLANK"><span class="badge bg-secondary">Print</span></a> <?php } ?>
                            </td>
                          </tr>
                          <?php } } else {
                            $data = mysqli_query($koneksi, "SELECT permohonanbiaya.*, user.nama FROM permohonanbiaya JOIN user ON permohonanbiaya.id_user=user.id WHERE idkeuangan!=0 and iddirektur=0 ORDER BY id DESC");
                            while($hdata = mysqli_fetch_array($data)){
                              $nobaris++; ?>
                              <tr>
                                <td><?=$nobaris?></td>
                                ...
                                <td class="text-center"><a href="index.php?page=detailspbap&id=<?=$hdata[0]?>"><span class="badge bg-info">Details</span></a>
                              <?php if($hdata[14]!=0){ ?>
                                <a href="printpb.php?id=<?=$hdata[0]?>" target="_BLANK"><span class="badge bg-secondary">Print</span></a> <?php } ?>
                              </td>
                              </tr>
