  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h1 class="text-center"><b>STATUS</b></h1>
            <h2 class="text-center"><b>PERMOHONAN BIAYA</b></h2><br><br>
              <div class="card mb-0">
                <div class="card-body">
                  <label for="">Keterangan Status Pengajuan : 
                  ...
                  <div class="table table-responsive">
                    <table class="table table-bordered" id="datatablee">
                      ...
                      <tbody>
                        <?php
                        $nobaris = 0;
                        $data = mysqli_query($koneksi, "SELECT permohonanbiaya.*, user.nama FROM permohonanbiaya JOIN user ON permohonanbiaya.id_user=user.id WHERE id_user='$iduser' and direktur = '' ORDER BY id DESC");
